...
<div class="container-fluid mtb-margin-top">    
    <div class="row">
        <div class="col-md-12">        
            ...
            $limit = 6;
            $adjacents = 2;
            $sql = "SELECT COUNT(*) 'total_rows' FROM `posts` WHERE `category`='" . $_GET['category'] ."'";
            ...
            $q = mysqli_query($db, "SELECT * FROM `posts` WHERE `category`='" . $_GET['category'] . "' order by ID desc limit $offset, $limit");
