...
<div class="container-fluid mtb-margin-top">    
    <div class="row">
        <div class="col-md-12">
            ...
            $limit = 6;
            $adjacents = 2;
            $sql = "SELECT COUNT(*) 'total_rows' FROM `posts` WHERE status='No active'";
            ...
            $query = "SELECT * FROM `posts` WHERE status= 'No active' limit $offset, $limit";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                <div class="row">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        ?>
                        <h5><span class="category"><?php echo $row['category'] ?></span></h5>
                        <div class="card-img">
                            <img src="https://placeimg.com/380/230/nature" alt="">                            
                        </div>
                        <div class="card-desc"
                             <h1><?php echo $row["title"] ?></h>
                                <h6><p class="text-truncate"><?php echo $row["post_text"] ?></p></h6>
