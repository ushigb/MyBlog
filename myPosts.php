...
<div class="container-fluid mtb-margin-top">    
    <div class="row">
        <div class="col-md-12">
            ...
            $limit = 6;
            $adjacents = 2;
            $sql = "SELECT COUNT(*) 'total_rows' FROM `posts` WHERE user_id =" . $_SESSION['user']['id'];
            ...
            $query = "SELECT * FROM `posts` WHERE user_id =" . $_SESSION['user']['id'] . " order by ID desc limit $offset, $limit";
